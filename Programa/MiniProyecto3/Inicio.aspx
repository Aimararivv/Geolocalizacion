<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="MiniProyecto3.Inicio" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>MiniProyecto Geolocalizacion</title>
      ...
      <div class="modal-body">
          ...
          <script > 
              $('#ModalMapPreview').locationpicker({
                  ...
                  radius: 0,
                  location: {
                      latitude: 27.43839884714486,
                      longitude: - 109.92800714022815
